...
- Internal-test upload AAB rebuilt on 2026-07-27: versionCode 28 / versionName 1.1.0, upload-key signature verified. Use this build only to collect the two real-device Billing records.
