...
try {
  ...
  Write-Host "Before the signed Play upload, confirm android/app/build.gradle remains above the last Play upload (currently versionCode 28 / versionName 1.1.0)."
  Write-Host "Also create/activate the Play Console managed products pip_cozy_support and pip_spoon_jar_small, then record real-device purchase/repeat validation in docs/ANDROID_RELEASE_STATUS.md."
