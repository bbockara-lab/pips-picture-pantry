...
async function verifyLargeBoardCatalogPuzzle(page, viewportName) {
  ...
  if (largeBoardChipCount < 83) {
    failures.push("[" + viewportName + "] Bakery Window should expose at least 83 12x12 catalog chips, saw " + largeBoardChipCount);
  }
  ...
  if (villageLargeBoardChipCount < 90) {
    failures.push("[" + viewportName + "] Village Pantry should expose at least 90 10x10 catalog chips, saw " + villageLargeBoardChipCount);
  }
  ...
  if (bakerySummaryLargeCount < 83 || !bakerySummaryText.includes("12x12")) {
    failures.push("[" + viewportName + "] Bakery Window catalog summary should expose at least 83 large boards and 12x12 max size, saw " + bakerySummaryText);
  }
  ...
  if (villageSummaryLargeCount < 90 || !villageSummaryText.includes("10x10")) {
    failures.push("[" + viewportName + "] Village Pantry catalog summary should expose at least 90 large boards and 10x10 max size, saw " + villageSummaryText);
  }
