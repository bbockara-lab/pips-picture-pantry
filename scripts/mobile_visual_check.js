...
async function verifyLargeBoardCatalogPuzzle(page, viewportName) {
  ...
  if (largeBoardChipCount < 69) {
    failures.push("[" + viewportName + "] Bakery Window should expose at least 69 12x12 catalog chips, saw " + largeBoardChipCount);
  }
  ...
  if (villageLargeBoardChipCount < 76) {
    failures.push("[" + viewportName + "] Village Pantry should expose at least 76 10x10 catalog chips, saw " + villageLargeBoardChipCount);
  }
  ...
  if (bakerySummaryLargeCount < 69 || !bakerySummaryText.includes("12x12")) {
    failures.push("[" + viewportName + "] Bakery Window catalog summary should expose at least 69 large boards and 12x12 max size, saw " + bakerySummaryText);
  }
  ...
  if (villageSummaryLargeCount < 76 || !villageSummaryText.includes("10x10")) {
    failures.push("[" + viewportName + "] Village Pantry catalog summary should expose at least 76 large boards and 10x10 max size, saw " + villageSummaryText);
  }
