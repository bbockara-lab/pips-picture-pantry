...
async function verifyLargeBoardCatalogPuzzle(page, viewportName) {
  ...
  if (largeBoardChipCount < 57) {
    failures.push("[" + viewportName + "] Bakery Window should expose at least 57 12x12 catalog chips, saw " + largeBoardChipCount);
  }
  ...
  if (villageLargeBoardChipCount < 64) {
    failures.push("[" + viewportName + "] Village Pantry should expose at least 64 10x10 catalog chips, saw " + villageLargeBoardChipCount);
  }
  ...
  if (bakerySummaryLargeCount < 57 || !bakerySummaryText.includes("12x12")) {
    failures.push("[" + viewportName + "] Bakery Window catalog summary should expose at least 57 large boards and 12x12 max size, saw " + bakerySummaryText);
  }
  ...
  if (villageSummaryLargeCount < 64 || !villageSummaryText.includes("10x10")) {
    failures.push("[" + viewportName + "] Village Pantry catalog summary should expose at least 64 large boards and 10x10 max size, saw " + villageSummaryText);
  }
