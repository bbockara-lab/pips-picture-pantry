...
async function verifyLargeBoardCatalogPuzzle(page, viewportName) {
  ...
  if (largeBoardChipCount < 79) {
    failures.push("[" + viewportName + "] Bakery Window should expose at least 79 12x12 catalog chips, saw " + largeBoardChipCount);
  }
  ...
  if (villageLargeBoardChipCount < 86) {
    failures.push("[" + viewportName + "] Village Pantry should expose at least 86 10x10 catalog chips, saw " + villageLargeBoardChipCount);
  }
  ...
  if (bakerySummaryLargeCount < 79 || !bakerySummaryText.includes("12x12")) {
    failures.push("[" + viewportName + "] Bakery Window catalog summary should expose at least 79 large boards and 12x12 max size, saw " + bakerySummaryText);
  }
  ...
  if (villageSummaryLargeCount < 86 || !villageSummaryText.includes("10x10")) {
    failures.push("[" + viewportName + "] Village Pantry catalog summary should expose at least 86 large boards and 10x10 max size, saw " + villageSummaryText);
  }
