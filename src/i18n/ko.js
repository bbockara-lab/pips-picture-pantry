export const ko = {
  ...
  badges: {
    ...
    artPendingShort: "\uC0C8 \uADF8\uB9BC \uC900\uBE44 \uC911",
    artPendingTiny: "\uC544\uD2B8",
    artPendingProgress: "{completed}/{total}\uC7A5 \uC800\uC7A5",
  ...
  pantry: {
    ...
    pendingEyebrow: "팬트리 준비 중",
    pendingTitle: "Pip이 새 소품 자리를 비워두고 있어요",
    pendingBody: "모아둔 스푼은 그대로 보관돼요. 새 꾸미기 소품이 준비되면 팬트리를 다시 열게요.",
