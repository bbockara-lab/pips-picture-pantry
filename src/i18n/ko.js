...
export const ko = {
  ...
  shelves: {
    ...
    apronDrawer: "\uc55e\uce58\ub9c8 \uc11c\ub78d",
    apronDrawerTeaser: "앞치마 서랍 속 아늑한 도구들을 발견해봐요",
    marketCounter: "\uc7a5\ud130 \uce74\uc6b4\ud130",
    marketCounterTeaser: "마켓 카운터의 싱싱한 풍경을 담아보세요",
    windowTable: "\ucc3d\uac00 \ud14c\uc774\ube14",
    windowTableTeaser: "창가 테이블에서 햇살을 바라보는 오후",
    morningBakery: "\uc544\uce68 \ube60\uc9d1",
    morningBakeryTeaser: "아침 베이커리의 구수한 냄새가 느껴져요",
    pastryCorner: "\ud398\uc774\uc2a4\ud2b8\ub9ac \uad6c\uc11d",
    pastryCornerTeaser: "달콤한 패스트리가 가득한 코너",
    tinRow: "\ud2f4 \uc120\ubc18",
    tinRowTeaser: "양철 통들이 줄지어 선 정겨운 선반",
    bakeryWindow: "\ube60\uc9d1 \ucc3d\uac00",
    bakeryWindowTeaser: "베이커리 창가 너머로 보이는 거리 풍경",
    villageSquare: "\ub9c8\uc744 \uad11\uc7a5",
    villageSquareTeaser: "마을 광장의 활기찬 하루를 담아요",
    marketTable: "\uc7a5\ud130 \ud14c\uc774\ube14",
    marketTableTeaser: "시장 테이블 위 알록달록한 제철 재료들",
    clockCorner: "\uc2dc\uacc4 \uad6c\uc11d",
    clockCornerTeaser: "시계 코너에서 느긋하게 흐르는 시간",
    bakeryWalk: "\ube60\uc9d1 \uc0b0\ucc45\uae38",
    bakeryWalkTeaser: "베이커리 산책로의 소소한 발견들",
    gardenPath: "\uc815\uc6d0 \uc0b0\ucc45\uae38",
    gardenPathTeaser: "정원 길을 따라 피어난 허브와 꽃들",
    villagePantry: "\ub9c8\uc744 \ud32c\ud2b8\ub9ac",
    villagePantryTeaser: "마을 팬트리의 모든 보물이 모였어요 🌿",
    herbTerrace: "허브 테라스",
    herbTerraceTeaser: "아침 햇살 아래 찻주전자와 허브, 정원 소품이 기다려요",
    sunroomTable: "햇살방 테이블",
    sunroomTableTeaser: "핍을 위한 마을의 포근한 보물들이 마지막 테이블에 모였어요",
    orchardWindow: "과수원 창가",
    orchardWindowTeaser: "종과 바구니, 과수원의 보물들이 창가에서 반짝여요",
    lanternCourtyard: "랜턴 안뜰",
    lanternCourtyardTeaser: "저녁 등불을 따라 포근한 마을 모임으로 걸어가요",
