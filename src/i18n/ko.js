export const ko = {
  ...
  pantry: {
    ...
    storyMilestoneBody: "첫 부탁을 마쳤어요. 이제 새 소품을 놓을 때마다 팬트리의 다음 장면과 이웃 이야기가 열려요.",
    storyMilestoneLevel: "\uBC29 \uB808\uBCA8",
    storyMilestoneLevelAria: "\uD32C\uD2B8\uB9AC \uBC29 \uB808\uBCA8",
    storyNextArrival: "다음 이웃의 부탁",
    storyNextArrivalAction: "{item} 부탁 살펴보기",
    storyDeliveryEyebrow: "Pip의 부탁 메모",
    storyDeliveryTitle: "{item}\uC744 \uC900\uBE44\uD574\uBCFC\uAE4C\uC694?",
    storyDeliveryBody: "Pip이 {slot} 자리에 놓을 소품으로 골랐어요. 스푼 {needed}개를 더 모으면 팬트리 이야기를 이어갈 수 있어요.",
    ...
    storyArchiveBody: "마친 부탁은 여기에 차곡차곡 남아요. 다음 방 단계와 새로운 이웃 이야기까지 얼마나 남았는지 확인해 보세요.",
    ...
    storyArchiveChapterBody: "다음 팬트리 장면까지 부탁 {count}/{target}개를 마쳤어요.",
    storyArchiveStageGoalLabel: "\uB2E4\uC74C \uD37C\uC990 \uC2A4\uD14C\uC774\uC9C0",
    storyArchiveStageGoal: "{stage}\uAE4C\uC9C0 \uBD80\uD0C1 {remaining}\uAC1C \uB354",
    storyArchiveStageCost: "스테이지 열기: 스푼 {saved}/{cost}개를 모았고, {needed}개 더 필요해요.",
    ...
    advisorAllBody: "장식 {count}개를 팬트리 자리 {slots}곳에 나누어 놓을 수 있어요. 꾸미고 싶은 자리를 골라 어울리는 소품을 살펴보세요.",
    ...
    progressMissionCompleteTitle: "첫 번째 방 이야기 완료",
