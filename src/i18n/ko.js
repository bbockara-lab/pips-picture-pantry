export const ko = {
  ...
  guide: {
    ...
    pantryNeighborMrPark: {
      title: "박 선생님이 우리 팬트리를 찾아왔어요",
      step1: "작은 시계 소리가 들리나요? 박 선생님은 늘 비슷한 시간에 마을을 산책해요. 오늘은 팬트리 문 앞에 멈춰 섰네요.",
      step2: "박 선생님은 조용한 자리와 따뜻한 수프 한 그릇을 좋아해요. 부탁 세 개를 마친 덕분에 손님을 맞을 준비가 됐어요.",
