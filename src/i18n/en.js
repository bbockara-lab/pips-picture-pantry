...
export const en = {
  ...
  shelves: {
    ...
    sunnyCounterTeaser: "Warm spoons and recipes are waiting on the counter",
    apronDrawer: "Apron Drawer",
    apronDrawerTeaser: "Discover the cozy tools tucked inside the apron drawer",
    marketCounter: "Market Counter",
    marketCounterTeaser: "Capture the fresh sights of the market counter",
    windowTable: "Window Table",
    windowTableTeaser: "A sunny afternoon waits at the window table",
    morningBakery: "Morning Bakery",
    morningBakeryTeaser: "The warm scent of the morning bakery is in the air",
    pastryCorner: "Pastry Corner",
    pastryCornerTeaser: "A corner filled with sweet pastries",
    tinRow: "Tin Row",
    tinRowTeaser: "A cheerful shelf lined with familiar baking tins",
    bakeryWindow: "Bakery Window",
    bakeryWindowTeaser: "See the village street beyond the bakery window",
    villageSquare: "Village Square",
    villageSquareTeaser: "Picture a lively day in the village square",
    marketTable: "Market Table",
    marketTableTeaser: "Colorful seasonal ingredients cover the market table",
    clockCorner: "Clock Corner",
    clockCornerTeaser: "Time drifts gently through the clock corner",
    bakeryWalk: "Bakery Walk",
    bakeryWalkTeaser: "Little discoveries wait along the bakery walk",
    gardenPath: "Garden Path",
    gardenPathTeaser: "Follow the herbs and flowers along the garden path",
    villagePantry: "Village Pantry",
    villagePantryTeaser: "Every treasure in the village pantry is gathered here 🌿",
    herbTerrace: "Herb Terrace",
    herbTerraceTeaser: "Teapots, herbs, and garden finds wait in the morning light",
    sunroomTable: "Sunroom Table",
    sunroomTableTeaser: "A final table of warm village keepsakes is ready for Pip",
    orchardWindow: "Orchard Window",
    orchardWindowTeaser: "Bells, baskets, and orchard treasures glow beside the window",
    lanternCourtyard: "Lantern Courtyard",
    lanternCourtyardTeaser: "Follow the evening lamps to one more cozy village gathering",
