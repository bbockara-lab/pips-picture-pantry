...
const SHELF_BLUEPRINT = [
  { id: "shelf-pips-first", titleKey: "shelves.pipsFirst", sizes: { 5: 15, 8: 5 }, unlockCost: 0, pantryRoomStepRequired: 0, stageBonus: 50, artPackId: "pips-first-shelf" },
  { id: "shelf-sunny-counter", titleKey: "shelves.sunnyCounter", sizes: { 5: 10, 8: 10 }, unlockCost: 0, pantryRoomStepRequired: 5, stageBonus: 30, artPackId: "sunny-spoon-sign" },
  { id: "shelf-apron-drawer", titleKey: "shelves.apronDrawer", sizes: { 5: 5, 8: 12, 10: 3 }, unlockCost: 0, pantryRoomStepRequired: 10, stageBonus: 30, artPackId: "apron-drawer" },
  { id: "shelf-market-counter", titleKey: "shelves.marketCounter", sizes: { 5: 5, 8: 8, 10: 9 }, unlockCost: 0, pantryRoomStepRequired: 15, stageBonus: 25, artPackId: "bakery-window" },
  { id: "shelf-window-table", titleKey: "shelves.windowTable", sizes: { 5: 5, 8: 7, 10: 10 }, unlockCost: 0, pantryRoomStepRequired: 15, stageBonus: 25, artPackId: "bakery-window" },
  { id: "shelf-morning-bakery", titleKey: "shelves.morningBakery", sizes: { 8: 8, 10: 10, 12: 5 }, unlockCost: 0, pantryRoomStepRequired: 20, stageBonus: 25, artPackId: "bakery-window" },
  { id: "shelf-pastry-corner", titleKey: "shelves.pastryCorner", sizes: { 10: 11, 12: 12 }, unlockCost: 0, pantryRoomStepRequired: 20, stageBonus: 30, artPackId: "bakery-window" },
  { id: "shelf-tin-row", titleKey: "shelves.tinRow", sizes: { 10: 11, 12: 12 }, unlockCost: 0, pantryRoomStepRequired: 25, stageBonus: 30, artPackId: "bakery-window" },
  { id: "shelf-bakery-window", titleKey: "shelves.bakeryWindow", sizes: { 10: 11, 12: 12 }, unlockCost: 0, pantryRoomStepRequired: 25, stageBonus: 30, artPackId: "bakery-window" },
  { id: "shelf-village-square", titleKey: "shelves.villageSquare", sizes: { 10: 11, 12: 12 }, unlockCost: 0, pantryRoomStepRequired: 30, stageBonus: 35, artPackId: "village-pantry" },
  { id: "shelf-market-table", titleKey: "shelves.marketTable", sizes: { 10: 11, 12: 12 }, unlockCost: 0, pantryRoomStepRequired: 30, stageBonus: 35, artPackId: "village-pantry" },
  { id: "shelf-clock-corner", titleKey: "shelves.clockCorner", sizes: { 10: 10, 12: 13 }, unlockCost: 0, pantryRoomStepRequired: 35, stageBonus: 35, artPackId: "village-pantry" },
