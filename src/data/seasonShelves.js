...
const SHELF_BLUEPRINT = [
  { id: "shelf-pips-first", titleKey: "shelves.pipsFirst", sizes: { 5: 15, 8: 5 }, unlockCost: 0, pantryRoomStepRequired: 0, stageBonus: 40, artPackId: "pips-first-shelf" },
  { id: "shelf-sunny-counter", titleKey: "shelves.sunnyCounter", sizes: { 5: 10, 8: 10 }, unlockCost: 60, pantryRoomStepRequired: 1, stageBonus: 25, artPackId: "sunny-spoon-sign" },
