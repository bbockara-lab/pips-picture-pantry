export const characterIdentity = [
  {
    ...
    note: "Curious, capable, and warm. She remains the main character.",
    ...
    identityGuardrail: "Keep Elena as the active story lead. Pip may support or react, but must not replace her decisions.",
    franchiseCore: true
  },
  {
    id: "pip",
    name: "Pip",
    role: "Capybara helper",
    note: "Calm mascot, clue carrier, and emotional anchor.",
    ...
    voiceRule: "Use short sounds, signs, and body language. Pip rarely speaks in full sentences and never explains the lesson directly.",
    identityGuardrail: "Keep Pip recognizably capybara-shaped, pet-like, and emotionally steady; avoid turning him into a loud talking comic sidekick.",
    franchiseCore: true
  },
  {
    id: "aunt-mina",
